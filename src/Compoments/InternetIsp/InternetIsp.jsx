      ...
      <div className="cardi">
        ...
        <ul>
          <li>
            ...
            <span className="price">$30</span><span>/MO</span>
          </li>
          <li>
            <span className="left-content">7M - 10M</span>
            <span className="price">$35</span><span>/MO</span>
          </li>
          <li>
            <span className="left-content">8M - 12M</span>
            <span className="price">$45</span><span>/MO</span>
          </li>
          <li>
            <span className="left-content">9M - 16M</span>
            <span className="price">$55</span><span>/MO</span>
          </li>
          <li>
            <span className="left-content">15M - 30M</span>
            <span className="price">$75</span><span>/MO</span>
          </li>
          <li>
            <span className="left-content">30M - 50M</span>
            <span className="price">$120</span><span>/MO</span>
          </li>
        </ul>
      </div>
